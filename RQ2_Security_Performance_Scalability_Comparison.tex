\subsubsection{Security and performance measures used (D4)}\label{sec:rq2-d4}
\input{Tables/Finding_Comparison}We compare observations from our three open-ended questions with regards to the security and performance-related features:
...
%reported that performance testing is a common testing practice in New Zealand.
