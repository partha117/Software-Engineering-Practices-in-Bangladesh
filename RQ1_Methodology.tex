...
% Thus we have
% calculated the Cram\'{e}r's V \cite{Cramer1946} between the choice of software
...
% variables~\cite{Sheskin2007}. However, we have not found any significant
% correlation.
...
\nd\it{\bf{RQ1-D1. Software development methodologies used.}} Developers of the Bangladeshi SE industry generally spend more time on implementation-related activities than planning and testing. \gias{add more findings}
\end{tcolorbox}
