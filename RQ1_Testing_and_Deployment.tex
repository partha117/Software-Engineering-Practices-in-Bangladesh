...
\nd\it{\bf{RQ1-D3. Software testing and devops practices used.}} There has a large demand of software testing tools in Bangladesh. 
However, there is a tendency among most Bangladeshi developers not to use automated testing regularly.  \gias{summarize RQ1-D3 here}
\end{tcolorbox}