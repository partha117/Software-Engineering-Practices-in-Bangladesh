...
\end{figure}
\bf{Security (Q23):} Our open coding of the survey responses reveals three main categories of security-related development practices: 
\begin{inparaenum}
\item Practises related to authentication and authorization measures (64.82\%),
...
7.41\% of respondents use encryption technologies to encrypt their data. Respondents use encryption at the different levels of software architecture such as network, data, and transmission.
\surveyquote{use encryption at different level of software (server, network, transmission layer, database and software layer.)}{35}
...
\begin{inparaenum}
\item Exploitation of tools and frameworks to ensure product performance (58.18\%).
\item Use of design principles/best practices to ensure security in products (32.73\%).
\item Use of testing to ensure software performance (21.82\%), and
\item Use of review and feedback to ensure software performance (21.82\%).
\end{inparaenum} 
