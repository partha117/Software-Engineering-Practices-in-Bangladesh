...
\begin{inparaenum}
\item Practises related to authentication and authorization measures (25.6\%),
\item Exploitation of tools and techniques to ensure security in products (21.2\%), and 
\item Use of encryption technologies for data (2.9\%).
\end{inparaenum} 
