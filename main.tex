...
\textbf{\it{Conclusion:}} The development practices in Bangladesh are mostly similar to other developing countries (e.g., Malaysia), but differ from 
...
testing web-based systems which are mostly developed in Bangladesh. In contrast, 
non-functional requirements like security, scalability are equally considered as important. Therefore, more emphasis can 
